  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-full lg:w-[340px] border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50 p-6 overflow-y-auto min-h-0">
        ...
        <div className="mb-8 flex-shrink-0">
            <div className="flex items-center gap-2 text-[var(--accent-500)] dark:text-[var(--accent-400)] mb-2 font-medium">
                <Calendar size={18} />
            ...
            <h3 className="text-2xl text-gray-400 dark:text-gray-500 font-medium mb-4">
              {currentDate.toLocaleDateString(undefined, { month: 'long', day: 'numeric' })}
            </h3>
            
            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-800 pb-4">
                <div className="relative group cursor-pointer hover:text-[var(--accent-500)] dark:hover:text-[var(--accent-400)] transition-colors flex items-center gap-2">
        ...
        <div className="flex flex-col gap-6 flex-1 overflow-y-auto">
            ...
            <div>
                <label className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 block">Context</label>
                <MetadataBar 
                    mood={mood} 
                    setMood={setMood} 
            ...
            <div>
                <div className="mb-6">
                    <label className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 block">Tags</label>
                    <TagInput tags={tags} onChange={setTags} />
                </div>

                {todaysSleepSessions.length > 0 && (
                    <div>
                        <label className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 block">Sleep Data</label>
